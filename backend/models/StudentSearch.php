...
class StudentSearch extends Student
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['stu_account', 'stu_name', 'stu_password', 'login_date'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'stu_account', $this->stu_account])
            ->andFilterWhere(['like', 'stu_name', $this->stu_name])
            ->andFilterWhere(['like', 'stu_password', $this->stu_password])
