...
?>
<div class="subject-more-child_subjective">
	
	<?php $form = ActiveForm::begin(); ?>
	<input type="hidden" name="ChildSubjective[pid]" value="<?= $id ?>">
...
<script>
	$().ready(function () {
		$('#star').raty({
			...
			scoreName: 'ChildSubjective[level]'
		});
	});
</script>
