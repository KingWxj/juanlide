			...
			<div class="center-login">
				...
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<?= Html::beginForm(Url::to(['login/index']), 'post') ?>
						<div class="form-group">
							<?= Html::label('Username') ?>
							<div class="input-group input-group-icon">
								<?= Html::activeInput('text', $model, 'admin_name', ['class' => 'form-control bk-noradius']) ?>
							...
							<?= Html::error($model, 'admin_name') ?>
						</div>
						
						<div class="form-group">
							<?= Html::label('Password') ?>
							<div class="input-group input-group-icon">
								<?= Html::activeInput('password', $model, 'admin_password', ['class' => 'form-control bk-noradius']) ?>
								<span class="input-group-addon">
												<span class="icon">
							...
							<?= Html::error($model, 'admin_password') ?>
						</div>
						<br/>
						<div class="row">
							<div class="col-sm-8">
								<div class="checkbox-custom checkbox-default bk-margin-bottom-10">
									<?=Html::checkbox('Login[remember]',[],['id'=>'RememberMe'])?>
