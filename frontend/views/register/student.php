	...
	<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
			...
			<div class="form-group" id="name-group">
				<label class="col-lg-3 control-label"><span class="must-input">* </span>学生姓名</label>
				<div class="col-lg-5">
					<?= Html::activeInput('text', $model, 'stu_name', ['class' => 'form-control', 'placeholder' => '学生姓名', 'id' => 'name']) ?>
					<span id="yhm-error" class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
					<span style="color:red;font-size: small"><?=Html::error($model,'stu_name')?></span>
			...
			<div class="form-group" id="user-group">
				...
				<div class="col-lg-5">
					<?= Html::activeInput('text', $model, 'stu_account', ['class' => 'form-control', 'placeholder' => '6位以上数字或字母', 'id' => 'user']) ?>
					...
					<span style="color:red;font-size: small"><?=Html::error($model,'stu_account')?></span>
			...
			<div class="form-group" id="pass-group">
				...
				<div class="col-lg-5">
					<?= Html::activeInput('password', $model, 'stu_password', ['class' => 'form-control', 'placeholder' => '密码', 'id' => 'password']) ?>
					<!--						<input type="password" class="form-control" id="password" name="password"/>-->
					<span id="mi-error" class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
					<span style="color:red;font-size: small"><?=Html::error($model,'stu_password')?></span>
			...
			<div class="form-group">
				<div class="col-lg-9 col-lg-offset-3">
					...
					<a class="btn btn-primary btn-lg" href="<?= Url::to(['register/teacher']) ?>">&gt;&gt;&gt;&gt;注册老师账户</a>
				</div>
			</div>
			<?= Html::endForm() ?>
		</div>
