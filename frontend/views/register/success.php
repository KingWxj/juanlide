...
<div id="js-alert-box" class="alert-box">
	...
	<div class="alert-body">
		...
		<div class="alert-concent">
			<p>注册成功，请到您的邮箱查收激活邮件</p>
			<p>如果找不到激活邮件，请留意您的邮件回收站</p>
			<a href="<?=\yii\helpers\Url::to(['register/resend'])?>">没有收到？重发一封</a>
		</div>
		<a id="js-alert-btn" class="alert-btn" href="<?=\yii\helpers\Url::to(['index/index'])?>">转到主页登录</a>
	</div>
	...
	function alertSet(e) {
		...
		document.getElementById("js-sec-text").innerHTML = t,
			setInterval(function() {
					if (0 == t){
						location.href="<?=\yii\helpers\Url::to(['index/index'])?>";
					}else {
						t -= 1,
							document.getElementById("js-sec-text").innerHTML = t;
...
<script>alertSet('Welcome');</script>
